    ...
    <div class="container py-3">
        <main>
            <div class="py-3 text-center">
                <h2>Tải về</h2>
                <div>
                    <a href="./taive/Nro.apk" class="btn btn-primary text-white my-2" download>
                        <i class="fa fa-download"></i> Mod Android - APK
                    </a>
                </div>
                <div>
                    <a href="./taive/Nro.ipa" class="btn btn-primary text-white my-2" download>
            ...
            <div>
                Đối với phiên bản iphone vui lòng làm theo hướng dẫn video dưới đây <a href="#" class="btn btn-primary text-white my-2" download style="margin-left: 60px;">
